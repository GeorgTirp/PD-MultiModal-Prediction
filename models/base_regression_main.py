...
def main(
    ...
    linear_model.plot(f"Actual vs. Prediction (Linear Regression) - MoCA")
    #_,_, removals= linear_model.feature_ablation(folds=folds, tune=tune, tune_folds=tune_folds, members=members)
    #log_obj.close()
...
if __name__ == "__main__":
    ...
    for exp_info in exp_infos:
        ...
        main(folder_path=folder_path, 
            ...
            out=f"results/{exp_number}_{target_col}_stim/level2/LinReg", 
            folds=10, 
            tune_folds=5, 
            tune=True, 
            members=1,
