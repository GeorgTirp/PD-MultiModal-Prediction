...
class NIGLogScore(LogScore):
    """
    Unified Normal-Inverse-Gamma score with optional Tobit censoring bounds.
    If lower_bound or upper_bound are set (scalars or array-like),
    censored observations use tail-probability terms in score and gradient.
    """
    lower_bound = None
    upper_bound = None
